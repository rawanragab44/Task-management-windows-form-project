...
namespace EvaluationProject.Migrations
{
    ...
    [Migration("20250223095611_assign_tasks_to_category")]
    partial class assign_tasks_to_category
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EvaluationProject.Models.TaskItem", b =>
                {
                    b.HasOne("EvaluationProject.Models.Category", "Category")
                        .WithMany("TaskItems")
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EvaluationProject.Models.User", "User")
                        .WithMany("TaskItems")
